...
public:
	...
	/** Deprecated authoring surface; retained for serialized compatibility and resolver fallback. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Fragments Array",
		meta = (DeprecatedProperty, DeprecationMessage = "Legacy fragment authoring: use ItemFragments and UItemFragment. Retained for serialized compatibility."))
